...
#
#     PHX_SERVER=true bin/zockelo start
#
...
# Build hash — injected into the service worker to version the cache.
...
if config_env() == :prod do
  ...
  eventstore_url =
    System.get_env("EVENT_STORE_URL") ||
      ...
      For example: ecto://USER:PASS@HOST/DATABASE_eventstore
      """
  ...
  config :zockelo, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
