...
config :zockelo, Zockelo.Repo,
  username: "postgres",
  password: "postgres",
  hostname: "localhost",
  database: "zockelo_test#{System.get_env("MIX_TEST_PARTITION")}",
  pool: Ecto.Adapters.SQL.Sandbox,
  pool_size: System.schedulers_online() * 2

# EventStore test database
...
config :zockelo, ZockeloWeb.Endpoint,
  ...
  secret_key_base: "8U9z8U+TiyN6aW3NeyIoypH9MzFRv0ymARt05REsGbLKeZfozClPzgmoRYw2f8dD",
  server: false

# In test we don't send emails
config :zockelo, Zockelo.Mailer, adapter: Swoosh.Adapters.Test
